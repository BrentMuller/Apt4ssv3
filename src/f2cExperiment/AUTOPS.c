/* AUTOPS.f -- translated by f2c (version 20100827).
...
/* ...  FORTRAN SUBROUTINE               AUTOPS */
/* Subroutine */ int autops_(void)
{
    /* Local variables */
#define can ((doublereal *)&_BLNK__1 + 40)
#define cosl ((doublereal *)&tlldat_1 + 16)
#define sinl ((doublereal *)&tlldat_1 + 8)
    extern /* Subroutine */ int apt201_(integer *, char *, ftnlen);
...
/* ---     SIZE OF BLANK COMMON IS ALLOCATED RIGHT HERE. */
    ...
    isv_1.limfl[ifxcor_1.ips - 1] = 0;
    ifxcor_1.ipsdef = 0;
    sv_1.tn[ifxcor_1.ips * 3 - 3] = znumbr_1.z0;
    sv_1.tn[ifxcor_1.ips * 3 - 2] = znumbr_1.z0;
    sv_1.tn[ifxcor_1.ips * 3 - 1] = -znumbr_1.z1;
