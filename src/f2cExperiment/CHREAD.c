/* CHREAD.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int chread_(integer *no, integer *irecno, char *cdata, 
...
/* ---- SEQUENTIAL ACCESS FILE */
	...
	for (i__ = 1; i__ <= i__2; ++i__) {
	    i__1 = do_uio(&c__1, cdata + i__, (ftnlen)1);
	    if (i__1 != 0) {
		goto L80;
	    }
	}
...
L90:
    slen = 0;
    cform_(" *** ERROR READING BY CHREAD FROM FILE :", darray, &c__2, &slen, (
	    ftnlen)40, (ftnlen)80);
    posn = slen + 3;
    slen = 0;
