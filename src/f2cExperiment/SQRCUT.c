/* SQRCUT.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int sqrcut_(doublereal *u0, doublereal *v0, doublereal *u1, 
	doublereal *v1, doublereal *u, doublereal *v, integer *ickbn)
{
    /* Initialized data */
    ...
    static doublereal vsmal = 1e-12;

    /* System generated locals */
    doublereal d__1, d__2;

    /* Local variables */
    static doublereal d__, a1, a2, a3, d2;
    static integer i1, i2;
    static doublereal u2, v2, dt;
