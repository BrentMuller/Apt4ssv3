/* INDIRV.f -- translated by f2c (version 20100827).
...
static integer c__21001 = 21001;
static integer c__21002 = 21002;
static integer c_b25 = -21003;

/* *** SOURCE FILE : M0002758.V07   *** */


/* .....FORTRAN SUBROUTINE             INDIRV...              3/1/68   GK */
/* Subroutine */ int indirv_(doublereal *srfc, doublereal *vct)
{
...
#define srface ((doublereal *)&hsave_1 + 27)
#define valhds (equiv_4)
    extern /* Subroutine */ int holfrm_(doublereal *, char *, integer *, 
	    integer *, integer *, ftnlen);
#define vector ((doublereal *)&hsave_1 + 28)
...
/* ...  STORE DIRECTION VECTORS FOR DS,PS,CS AS REQUIRED */
    ...
    *srface = *srfc;
    ...
    transm_(vector, &vct[1], &c__3, &c__3, &c__0);
    if (hold_1.jhldfg == 0) {
	goto L501;
    }
    hold_1.itabh[hold_1.ithcnt - 1] = 11;
    ++hold_1.ithcnt;
    return 0;
L501:
    if (ifxcor_1.igoto <= 0) {
...
L5:
    for (i__ = 1; i__ <= 3; ++i__) {
	sv_1.vndir[i__ + k * 3 - 4] = vector[i__ - 1];
/* L10: */
    }
...
L20:
    aercom_1.iaerfg = 1;
    aerr_(&c__21001, "INDIRV  ", (ftnlen)8);
    goto L45;
L25:
...
L40:
    aercom_1.iaerfg = 1;
    aerr_(&c__21002, "INDIRV  ", (ftnlen)8);
L45:
    ifxcor_1.iaerr = 0;
    goto L1000;
L50:
    aerr_(&c_b25, "INDIRV  ", (ftnlen)8);
...
/* Subroutine */ int indrvh_(doublereal *srfc, doublereal *vct)
{
    /* System generated locals */
    static doublereal equiv_4[1];
...
L20:
    aercom_1.iaerfg = 1;
    aerr_(&c__21001, "INDRVH  ", (ftnlen)8);
    goto L45;
L25:
    isv_1.indir__[k - 1] = knumbr_1.k1;
/* ...  IF DS,TELL AMIND VNDIR IS ALREADY THE FORWARD DIRECTION */
...
L40:
    aercom_1.iaerfg = 1;
    aerr_(&c__21002, "INDRHV  ", (ftnlen)8);
L45:
    ifxcor_1.iaerr = 0;
    goto L1000;
L50:
    aerr_(&c_b25, "INDRVH  ", (ftnlen)8);
    ihds[0] = bcdf_(hblock_1.hds, (ftnlen)4);
    ihds[1] = bcdf_(hblock_1.hds + 4, (ftnlen)4);
    fxcor_1.temp[0] = *valhds;
    goto L3;
