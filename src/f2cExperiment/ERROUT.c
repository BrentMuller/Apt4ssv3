/* ERROUT.f -- translated by f2c (version 20100827).
...
/* .....FORTRAN SUBROUTINE             ERROUT... */

/* PURPOSE      TO PRINT DIAGNOSTICS */

/* LINKAGE      CALL ERROUT(NERR) */

/* ARGUMENTS    NERR       INTEGER ERROR NUMBER */


/* Subroutine */ int errout_(integer *nerr)
{
    /* Initialized data */
...
L30:
    ...
    goto L10;
L40:
    cform_(notext, b, &c__8, &c__52, (ftnlen)52, (ftnlen)120);
